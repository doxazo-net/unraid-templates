...
Instead, use [GitHub Security Advisories](https://github.com/sydlexius/unraid-templates/security/advisories/new)
...
- Vulnerabilities in upstream dependencies (please report those to the upstream
  project; this repository forwards Dependabot security alerts automatically)
